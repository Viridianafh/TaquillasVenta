document.addEventListener('DOMContentLoaded', (event) => {
    ...
    button_Buscar.addEventListener('click', () => {
        ...
        fetch(`https://localhost:5001/Home/ListaDeViajes?fechainicio=${Fecha_entrada}&fechafinal=${Fecha_salida}`, {
        })
    ...
    function verlista(tripid) {
        ...
        fetch(`https://localhost:5001/Home/MostrarListaAbordar?trip_id=${tripid}`)
            .then(response => response.json())
            .then(data => {
